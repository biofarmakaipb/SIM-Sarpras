            ...
            <div class="tab-content">
              <div id="daftar_inventaris" class="tab-pane fade in active">
                <div class="btn-toolbar">
                  <a class="btn btn-xl btn-group btn-primary pull-left" href="/excel"><i class="fa fa-file-excel-o"></i> Export Data</a>
                  ...
                  <a class="btn btn-xl btn-group btn-success pull-right" href="/inventaris/create"><i class="fa fa-plus"></i> Tambah</a> 
                </div>
                <br>
                {{--datatable--}}
                <div class="row">
                                    ...
                                    @foreach($inventariss as $inventaris)
                                        <tr>
                                            ...
                                            <td><center>
                                                ...
                                                <a href="{{ route('inventaris.edit', Hashids::encode($inventaris->id)) }}" role="button" class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-edit"></i> Ubah</a>
                                                <a id="" href="/inventarisDelete/{{Hashids::encode($inventaris->id)}}" class="btn btn-xs btn-danger" onclick="return confirm('Apakah anda yakin akan menghapus item ini ?');"><i class="glyphicon glyphicon-trash"></i> Hapus</a>
                                              </center>
                                            </td>
                                        </tr>
                                    @endforeach
              ...
              <div id="sampah" class="tab-pane fade">
                <div class="row">
                    ...
                    @if($inventaris_trashed->count())
                      <div class="btn-toolbar">
                        <a class="btn btn-xl btn-group btn-default pull-left" href="/inventarisDeletePermanentAll"><i class="fa fa-trash-o"></i> Kosongkan Sampah</a>
                        <a class="btn btn-xl btn-default pull-left" href="/restore_all"><i class="glyphicon glyphicon-repeat"></i> Pulihkan Semua</a> 
                      </div><br>
                      <div class="panel panel-default">
                          <div class="panel-heading">
                              Data Inventaris
                                    ...
                                    @foreach($inventaris_trashed as $inventaris)
                                        <tr>
                                            ...
                                            <td><center>
                                                ...
                                                <a href="/restore_id/{{$inventaris->id}}" role="button" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-repeat"></i> Pulihkan</a>
                                                <a id="" href="/inventarisDeletePermanent/{{$inventaris->id}}" class="btn btn-xs btn-danger" onclick="return confirm('Apakah anda yakin akan menghapus item ini selamanya?');"><i class="glyphicon glyphicon-trash"></i> Hapus</a>
                                              </center>
                                            </td>
                                        </tr>
                                    @endforeach
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="/excelSearch" method="get" id="form1">
                          <p>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <strong>
                           <?php $splitted1 = preg_split('/\//', "/upload/file/Download Contoh File.xls"); ?><a href="{{asset("/upload/file/Download Contoh File.xls") }}" style="color: #23527c;" download>{{$splitted1[sizeof($splitted1) - 1]}}</a>
                        </strong>

                        <strong>
                          <p>
                            Pastikan atribut kode barang tidak kosong !
                          </p>
                        </strong>
                        <form action="/importExcel" id="form_import" enctype="multipart/form-data" method="POST">
